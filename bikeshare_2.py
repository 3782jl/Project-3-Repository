...
CITY_DATA = { 'chicago': 'C:/Users/jl3782/OneDrive - AT&T Services, Inc/Desktop/Py4e/chicago.csv',
              'new york city': 'C:/Users/jl3782/OneDrive - AT&T Services, Inc/Desktop/Py4e/new_york_city.csv',
              'washington': 'C:/Users/jl3782/OneDrive - AT&T Services, Inc/Desktop/Py4e/washington.csv' }
...
def get_filters():
    ...
    while month not in months:
        month = input('Nope, that month name won\'t work.Please Try Again!')
        month = month.casefold()
    ...
    while day not in days:
        day = input('Nope, that day name won\'t work.Please Try Again!')
        day = day.casefold()
...
def load_data(city, month, day):
    """
    Loads data for the city and filters by month and day if any.
    Args:
    ...
    if month != 'all':
        # Using the index of the months list to get corresponding integer
